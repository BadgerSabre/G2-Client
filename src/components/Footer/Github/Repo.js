const Repo = ({ data, header }) => {
    return (
        <div className='f-sec col-8 col-md-4 col-lg-3'>
            <h5>Check out the {header}</h5>
            {data.map(d => (
                <div key={d.title} className='github' onClick={() => window.open(`${d.link}`)}>
